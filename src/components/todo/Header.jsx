...
const HeaderComponent = () => {
  ...
  const {isAuthenticated: isAuthenticated} = authContext;
    ...
    <div className="container">
        <div className="row">
            <nav className="navbar navbar-expand-lg">
                <a className="navbar-brand ms-2 fs-2 fw-bold text-black" href="https://www.in28minutes.com">Yogurt</a>
                <div className="collapse navbar-collapse">
                    <ul className="navbar-nav">
                        {isAuthenticated && <li className="nav-item fs-5"><Link className="nav-link" to="/home/hsk">Home</Link></li> }
